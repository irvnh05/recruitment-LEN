                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                                    <tr>
                                        <td align="center" style="font-size:0px;padding:10px 25px;padding-top:30px;padding-right:25px;padding-bottom:30px;padding-left:25px;word-break:break-word;">
                                            <div style="font-family:Playfair Display, Times New Roman, serif;font-size:30px;font-weight:bold;line-height:1;text-align:center;color:#071C4D;">INFORMASI LAMARAN!</div>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                                                    <tr>
                                                        <td align="left" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;">
                                                            <div style="font-family:Assistant, Helvetica, Arial, sans-serif;font-size:18px;line-height:1;text-align:left;color:#071C4D;">Hi,  {{ $data->biodata->Nama_Lengkap }}
                                                                <br>
                                                                @if  ($data->status=="Interview")
                                                                <br>Selamat Pengajuan Lamaran Kamu Dengan Posisi Lowongan {{ $data->lowongan->posisi }}.
                                                                Dinyatakan,<h4>{{ $data->status }}</h4>
                                                                <br> Dan Tunggu Informasi Selanjutnya Perihal Jadwal Interview</br>            
                                                    ...
                                                    <tr>
                                                        <td align="center" vertical-align="middle" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                            <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;line-height:100%;">
                                                                <tr>
                                                                    <td align="center" bgcolor="#336fe8" role="presentation" style="border:none;border-radius:10px;cursor:auto;padding:10px 25px;background:#336fe8;" valign="middle">
                                                                      <a href="{{ route('lamaran.index') }}" style="background:#336fe8;color:#ffffff;font-family:Assistant, Helvetica, Arial, sans-serif;font-size:18px;font-weight:bold;line-height:120%;Margin:0;text-decoration:none;text-transform:none;">Check Status</a>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                    ...
                                    <tr>
                                        <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            <table cellpadding="0" cellspacing="0" width="100%" border="0" style="cellspacing:0;color:#000000;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;table-layout:auto;width:100%;">
                                                <tr>
                                                    <td style="width: 50px;"><img src="{{ url('landing/assets/images/LogoLen.png') }}" width="50px"></td>
                                                    <td style="font-size: 18px; padding-left: 10px; color: #071C4D; font-family: Assistant, Helvetica, Arial, sans-serif">support@recruitmentlen.com
                                                        <br>021-2019-2022</td>
                                                </tr>
                                            </table>
                                        </td>
