  ...
  <div class="container-fluid">
    <div class="dashboard-heading">
        ...
        <p class="dashboard-subtitle">
            Create New Data Pendidikan Formal
        </p>
    </div>
    <div class="dashboard-content">
      <div class="row">
        <div class="col-12">
          ...
          @endif
          <form action="{{ route('pendidikanformal.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="card">
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      <label>Lulusan Tahun Ajaran</label>
                      <input id="datepicker" type="text"  class="form-control" name="Tahun" required />
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group">
