...
<?php if ($soal->pila) {?>
	<div class="jawab {{ $jawab == 'A' ? 'dijawab' : '' }}"
		soal-id="{{ $soal->soals_id }}"
		data-id="{{ $soal->id }}"
...
<?php } ?>
<?php if ($soal->pilb) {?>
	<div class="jawab {{ $jawab == 'B' ? 'dijawab' : '' }}"
		soal-id="{{ $soal->soals_id }}"
		data-id="{{ $soal->id }}"
...
<?php } ?>
<?php if ($soal->pilc) {?>
	<div class="jawab {{ $jawab == 'C' ? 'dijawab' : '' }}"
		soal-id="{{ $soal->soals_id }}"
		data-id="{{ $soal->id }}"
...
<?php } ?>
<?php if ($soal->pild) {?>
	<div class="jawab {{ $jawab == 'D' ? 'dijawab' : '' }}"
		soal-id="{{ $soal->soals_id }}"
		data-id="{{ $soal->id }}"
...
<?php } ?>
<?php if ($soal->pile) {?>
	<div class="jawab {{ $jawab == 'E' ? 'dijawab' : '' }}"
		soal-id="{{ $soal->soals_id }}"
		data-id="{{ $soal->id }}"
