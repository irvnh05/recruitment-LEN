...
<section id="pengumuman" class="pricing-area">
    <div class="container">
            ...
            <div class="col-lg-6">
                ...
                <div class="single-pricing mt-40">
                    ...
                    <div class="pricing-list">
                        <ul>
                            <li><i class="lni-bullhorn"></i> {!!strlen($pengumuman->deksripsi) > 200 ? substr($pengumuman->deksripsi,0,200) : $pengumuman->deksripsi!!}</li>
                        </ul>
                    </div>
