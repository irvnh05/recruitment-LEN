...
class KeluargaController extends Controller
{
                    ...
                    return '
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu" aria-labelledby="action' .  $item->id . '">
                                    <a class="dropdown-item" href="' . route('keluarga.edit', $item->id) . '">
                                        Sunting
                                    </a>
    ...
    {
        return view('pages.user.keluarga.create');
    }
    ...
    {
        $item = SdrKwnLen::findOrFail($id);

        return view('pages.user.keluarga.edit',[
            'item' => $item
        ]);
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(KeluargaSaudaraRequest $request, $id)
    {
        $data = $request->all();
